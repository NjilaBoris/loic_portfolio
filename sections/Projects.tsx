...
const Projects = () => {
  return (
    <section className="py-24 md:py-32 lg:py-40 px-5" id="projects">
        ...
        <div className="mt-10 md:mt-16 lg:mt-20">
          {projects.map(({ name, image }) => (
            <Link
              href="/"
              key={name}
              className=" border-b group/project border-stone-400 relative border-dotted py-6 md:py-8 lg:py-10 flex flex-col"
            >
              ...
              <div className="pr-[1rem] relative">
                ...
                >
                  ...
                  <div className="relative">
                    <div
                      className="absolute aspect-video w-full top-1/2 -translate-y-1/2
                     opacity-0 scale-90 group-hover/project:opacity-100 group-hover/project:scale-100
                    ...
                    <div className="size-6 overflow-clip">
                      <div className="h-6 w-12 flex group-hover/project:-translate-x-1/2 transition-transform duration-300">
                        ...
                        <svg
                          ...
                          strokeWidth="1.5"
                          stroke="currentColor"
                          className="size-6 text-red-orange-500"
                        >
                          <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
